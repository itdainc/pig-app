...
if check_password():
    ...
    # ----------------- 통화 기반 수정된 기본 스펙 데이터 (우선순위 = 배정 순서) -----------------
    default_specs = [
        {"업체명": "염주골", "우선순위": 1, "목표두수": 20, "지급률": "105.0%", "중량(kg)": "98~109", "등지방(mm)": "20~27", "등급": "2", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "마루푸드", "우선순위": 2, "목표두수": 15, "지급률": "105.0%", "중량(kg)": "82~105", "등지방(mm)": "29~35", "등급": "1,1+,2", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "프라임미트", "우선순위": 3, "목표두수": 110, "지급률": "104.5%", "중량(kg)": "80~103", "등지방(mm)": "20~34", "등급": "1,1+,2", "암 비율": "70%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "흥부축산", "우선순위": 4, "목표두수": 25, "지급률": "103.5%", "중량(kg)": "75~86", "등지방(mm)": "18~22", "등급": "1,1+,2", "암 비율": "60%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "자운", "우선순위": 5, "목표두수": 15, "지급률": "107.5%", "중량(kg)": "85~95", "등지방(mm)": "22~25", "등급": "1,1+", "암 비율": "100%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "승민", "우선순위": 6, "목표두수": 5, "지급률": "107.5%", "중량(kg)": "84~88", "등지방(mm)": "20~22", "등급": "1,1+", "암 비율": "100%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "제이이", "우선순위": 7, "목표두수": 15, "지급률": "107.0%", "중량(kg)": "88~97", "등지방(mm)": "25~27", "등급": "1,1+", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "돼랑이", "우선순위": 8, "목표두수": 10, "지급률": "105.0%", "중량(kg)": "85~90", "등지방(mm)": "25~26", "등급": "1,1+", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "민강", "우선순위": 9, "목표두수": 60, "지급률": "107.0%", "중량(kg)": "85~97", "등지방(mm)": "21~25", "등급": "1,1+", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "대용식품", "우선순위": 10, "목표두수": 15, "지급률": "107.0%", "중량(kg)": "85~89", "등지방(mm)": "18~21", "등급": "1,1+", "암 비율": "60%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "명성", "우선순위": 11, "목표두수": 4, "지급률": "107.0%", "중량(kg)": "87~97", "등지방(mm)": "20~22", "등급": "1,1+", "암 비율": "80%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "예소야", "우선순위": 12, "목표두수": 20, "지급률": "107.0%", "중량(kg)": "85~97", "등지방(mm)": "18~27", "등급": "1,1+,2", "암 비율": "50%", "외관": "", "육질": "", "결함": "", "배제농가": ""},
        {"업체명": "미소", "우선순위": 13, "목표두수": 60, "지급률": "105.0%", "중량(kg)": "80~97", "등지방(mm)": "17~25", "등급": "1,1+", "암 비율": "60%", "외관": "", "육질": "", "결함": "", "배제농가": ""}
    ]
    ...
    if uploaded_grade:
        try:
            ...
            # 설정된 우선순위대로 정렬하여 순차 배정
            specs.sort(key=lambda x: x['우선순위'])

            pigs['배정거래처'] = '미배정'

            # 1차 순차 배정 실행 (우선순위 순서대로)
            for spec in specs:
                company = spec['업체명']
                target = spec['최대목표두수']
                if target <= 0:
